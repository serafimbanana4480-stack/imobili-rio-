...
def render_data_quality():
    ...
    if not clean_listings:
        st.warning(" Sem dados clean na base de dados. Execute o pipeline primeiro.")
        return
    ...
    if anomalies:
        ...
        st.warning(f" {len(anomalies)} anomalias de preço detetadas")
    ...
    from realestate_engine.etl.validators import ETLValidator, ValuationValidator, ScoringValidator
