...
@router.post("/", response_model=Union[ValuationResponse, AdvancedValuationResponse])
...
async def valuate_property(
    ...
    Args:
        request: Property data for valuation (includes use_advanced in body)
    ...
    try:
        ...
        use_advanced = listing_dict.pop("use_advanced", False)
...
async def valuate_listing_by_id(
    ...
    Args:
        ...
        request: Valuation options (use_advanced in body)
    ...
    try:
        ...
        use_advanced = request.model_dump().get("use_advanced", False)
        ...
        # Save valuation to database using validated schema
        from realestate_engine.database.models import Valuation
        from realestate_engine.api.schemas.valuation import ValuationCreate
        ...
        valuation = Valuation(**valuation_data.model_dump())
