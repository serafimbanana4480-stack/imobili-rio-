...
class Century21Spider(ExtractionMixin, BaseSpiderNodriver):
    """Spider for century21.pt."""

    name = "century21"
    DEFAULT_REGION = "porto"
    REGION_URLS = {
        "porto": "https://www.century21.pt/comprar/imoveis/distrito-porto/residencial",
        "lisboa": "https://www.century21.pt/comprar/imoveis/distrito-lisboa/residencial",
        "braga": "https://www.century21.pt/comprar/imoveis/distrito-braga/residencial",
        "coimbra": "https://www.century21.pt/comprar/imoveis/distrito-coimbra/residencial",
        "faro": "https://www.century21.pt/comprar/imoveis/distrito-faro/residencial",
        "setubal": "https://www.century21.pt/comprar/imoveis/distrito-setubal/residencial",
        "aveiro": "https://www.century21.pt/comprar/imoveis/distrito-aveiro/residencial",
        "leiria": "https://www.century21.pt/comprar/imoveis/distrito-leiria/residencial",
    }
        ...
        for selector in self.CARD_SELECTORS:
            ...
            (() => {{
                ...
                document.querySelectorAll({selector!r}).forEach(el => {{
                    const a = el.matches('a') ? el : el.querySelector('a[href*=\"/comprar/\"]');
                    if (!a) return;
    ...
    async def get_next_page(self) -> bool:
        try:
            clicked = await self.safe_evaluate(
                ...
                "'a[rel=\"next\"], .pagination-next a, a[aria-label*=\"next\" i]'"
