...
class ConsistencyValidator:
    ...
    def _check_location_consistency(self, listing: Dict) -> bool:
        """Check consistency between location fields"""
        ...
        if lat and lon and concelho:
            # This is a simplified check - in practice would use geocoding
    ...
    def _check_property_type_consistency(self, listing: Dict) -> bool:
        ...
        tipo = listing.get("tipo_imovel", "").lower()
...
class UniquenessValidator:
    ...
    def _is_duplicate(self, fingerprint: str) -> bool:
        ...
        try:
            ...
            # Check in database (simplified)
            # In practice, would query the database for existing fingerprints
            return False
