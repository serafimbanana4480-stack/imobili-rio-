...
def _load_heavy_modules():
    ...
    try:
        from realestate_engine.nlp.portuguese.analyzer import analyze_portuguese_description
    ...
    try:
        from realestate_engine.nlp.portuguese.bert_portuguese import BERTPortugueseProcessor
        ...
        from realestate_engine.nlp.portuguese.summarizer import DescriptionSummarizer
