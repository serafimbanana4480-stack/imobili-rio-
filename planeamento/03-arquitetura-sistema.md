...
class SpiderManager(ISpiderManager):
    def __init__(self, proxy_manager=None, stealth_manager=None):
        ...
        self.spiders = {
            # Nacionais (Tier 1) - IMPLEMENTADOS
            ...
            # Bancários (Tier 2) - PENDENTES IMPLEMENTAÇÃO
            # 'bpi': BPISpiderNodriver,      # PENDENTE
            # 'caixa': CaixaSpiderNodriver,   # PENDENTE
            # 'santander': SantanderSpiderNodriver, # PENDENTE
            # 'millennium': MillenniumSpiderNodriver, # PENDENTE
            # Regionais (Tier 3) - IMPLEMENTADOS
            'era': ERASpider,
            'century21': Century21SpiderNodriver,
            'supercasa': SuperCasaSpider,
            'remax': REMAXSpiderNodriver,
            # Alternativas implementadas
            'casa_sapo_direct': CasaSapoDirectSpider,
            'remax_direct': REMAXDirectSpider,
            'imovirtual_nextdata': ImovirtualNextDataSpider,
        }
...
- StealthManager
- Spiders (13 implementações vs 17 planeadas: 9 Nacionais/Regionais + 4 alternativas)
- **GAP:** 4 spiders bancários pendentes (BPI, Caixa, Santander, Millennium)
